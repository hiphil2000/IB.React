...
import {asyncStateHelper, createAsyncHandlers} from "../ReducerUtils";
 ...
 */
const getCurrentUserHandler = createAsyncHandlers<AuthState, typeof getCurrentUserAsync, keyof AuthState>(getCurrentUserAsync, "getCurrentUser");
